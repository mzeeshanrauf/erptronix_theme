        ...
        let AppLogoVM = new Vue({
            ...
            methods: {
                ...
                get_company_logo: function () {
                    const $this = this;
                    let logo = 'erptronix-logo.svg';
                    if ($('html').attr('data-theme-mode') == 'dark') {
                        logo = 'erptronix-logo-light.svg';
                    }
                    frappe.call({
                        type: 'POST',
                        method: 'erptronix_theme.api.get_company_logo',
                        args: {},
                        callback: async function (response) {
                            if (response.message && response.message.length) {
                                ...
                                $this.logo_class = '';
                                $this.logo_path = `/assets/erptronix_theme/images/${logo}`;
                            }
                        }
                    });
                }
        ...
        new Vue({
            ...
            methods: {
                get_current_language: function () {
                    const $this = this;
                    frappe.call({
                        method: "erptronix_theme.api.get_current_language",
                        args: {},
